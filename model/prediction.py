...
# Load the pre-trained models and run the logging inside the function to avoid circular import
def log_models_and_predictions():
...
# Call the function to execute the logging and prediction
log_models_and_predictions()
